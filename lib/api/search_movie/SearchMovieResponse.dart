...
SearchMovieResponse searchMovieRepositoryFromJson(String str) => SearchMovieResponse.fromJson(json.decode(str));

String searchMovieRepositoryToJson(SearchMovieResponse data) => json.encode(data.toJson());
...
class Result {
  ...
  String _dateToJson(DateTime? releaseDate) {
    if (releaseDate == null) {
      return "null";
    }
